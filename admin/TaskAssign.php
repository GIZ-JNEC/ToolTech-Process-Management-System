		...
		<div class="updateprofile-layer">
			...
			<div class="header-main1">
				...
				<div class="header-left-bottom">
					...
					<div class="bottom">
                        <button class="btn" type="button" name="back"><a href="AdminHome.php" style="color: black; ">Home</a></button>
</div>
<!--
					<form action="#" method="post">	
	...
	if(isset($_POST['assign'])) // onset assign button 
	{
        ...
        $result = $func->insert('task',array('task_name','task_details','task_project','dead_line','task_receiver','task_receiver_name','task_sender','task_sender_name','task_sender_image'),array("'$taskName'", "'$taskDetail'","'$taskProject'","'$taskDeadLine'","'$userId'","'$task_receiver_name'","'$myId'","'$myName'","'$myProfile'"));
