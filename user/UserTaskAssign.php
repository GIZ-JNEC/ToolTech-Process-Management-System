...
<body>
			...
			<div class="header-main1">
				...
				<div class="header-left-bottom">
					<form action="#" method="post">	
						...
						<div class="icon1">
							<span class="fa fa-user"></span>
							Task Receiver Name :  <input type="text" placeholder="  Enter Receiver Name" name="task_receiver_name" required=""/>
						</div>

						<div class="icon1">
							<span class="fa fa-user"></span>
							Task Details :  <br><br><textarea  name ="task_details" ></textarea>
						</div>	
					...
					<div class="bottom">
                       <center> <button class="btn" type="button" name="back"><a href="UserHome.php" style="color: white; ">Home</a></button> </div> </center>


					<!--<form action="#" method="post">	

						<div class="bottom">
							<a href="AllMates.php?user_id=<?php #echo $row["user_id"]; ?>" class="button"><button class="btn" type="submit" name="home" >HOME</button></a>
	...
	if(isset($_POST['assign']))
	{
		...
		$task_receiver_name=$_POST['task_receiver_name'];
		...
		// VALUES ('$taskName','$taskDate', '$taskDetail','$taskProject','$taskDeadLine', '$userId','$myId','$myName','$myProfile')"; 
		 ...
		 $result = $func->insert('task',array('task_name','task_issuedate','task_details','task_project','dead_line','task_receiver','task_receiver_name','task_sender','task_sender_name','task_sender_image'),array("'$taskName'","'$taskDate'", "'$taskDetail'","'$taskProject'","'$taskDeadLine'","'$userId'","'$task_receiver_name'","'$myId'","'$myName'","'$myProfile'"));
