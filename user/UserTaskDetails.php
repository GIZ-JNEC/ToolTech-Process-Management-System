...
<body>
  ...
  while($row = $result->fetch_assoc())
  {
    ...
    $taskReceiverName=$row["task_receiver_name"];
  ...
  <div class="w6layouts-main"> 
    <div class="seeprofile-layer">
      ...
      <div class="header-main1">
       <!--    <div class="main-icon"> -->
        ...
        <p style="color: white; "><?php echo "   Receiver Name :  "."$taskReceiverName"; ?></p>
    ...
    <center><div style="width:1100px;height:300px;">
      <form method="POST" name="f1" id="f1">
        ...
        <div class="bottom">
                        <button class="btn" type="button" name="back"><a href="UserHome.php" style="color: black; ">Home</a></button> </div>
      </form></div></center>
    </div>  
